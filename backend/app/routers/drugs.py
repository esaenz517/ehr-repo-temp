...
def list_drugs(
    ...
    current_user=Depends(require_permission("drug", "read")),
):
...
def create_drug(
    drug: DrugCreate,
    db: Session = Depends(get_db),
    current_user=Depends(require_permission("drug", "create")),
):
...
def delete_drug(
    drug_id: int,
    db: Session = Depends(get_db),
    current_user=Depends(require_permission("drug", "delete")),
):
